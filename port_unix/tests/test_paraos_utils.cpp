...
TEST(MsToTimeSpec, ZeroMs) {
  auto timespec = paraos::milliseconds_in_timespec(0);
...
TEST(MsToTimeSpec, Ms500) {
  auto timespec = paraos::milliseconds_in_timespec(500);
...
TEST(MsToTimeSpec, Ms1500) {
  auto timespec = paraos::milliseconds_in_timespec(1500);
...
TEST(MsToTimeSpec, Ms1400) {
  auto timespec = paraos::milliseconds_in_timespec(1400);
...
TEST(MsToTimeSpec, Ms1234) {
  auto timespec = paraos::milliseconds_in_timespec(1234);
...
TEST(MsToTimeSpec, Ms10_987) {
  auto timespec = paraos::milliseconds_in_timespec(10987);
